...
<?php endif; ?>
	...
	<div class="form-account register-account">

			<h2><?php esc_html_e( 'Crie sua conta', 'woocommerce' ); ?></h2>
			...
			<div class="btn-social">
				<a href="javascript:" class="btn btn-usar-email e-mail-register">
					...
					<form method="post" class="woocommerce-form woocommerce-form-register register">
						...
						<p class="woocommerce-FormRow form-row">
							...
							<button type="submit" class="btn btn-comprar woocommerce-Button button" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
						</p>
			...
			<div class="txt-link">
				Criando sua conta você concorda com as <a href="#">Condições de Uso</a> e <a href="3">Privacidade</a> da I-Pack.
			</div>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="form-account login-account">
...
<script type="text/javascript">
	jQuery('.e-mail-register').click(function(){
		jQuery('form.register').show();
		jQuery('#customer_login .btn-social').hide();
	});
</script>