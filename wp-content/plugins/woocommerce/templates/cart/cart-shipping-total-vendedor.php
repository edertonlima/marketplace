	...
	<div data-title="<?php echo esc_attr( $package_name ); ?>">
		...
		<?php elseif ( 1 === count( $available_methods ) ) :  ?>
			<?php
				...
				//printf( '%3$s <input type="hidden" name="shipping_method[%1$d]" data-index="%1$d" id="shipping_method_%1$d" value="%2$s" class="shipping_method" />', $index, esc_attr( $method->id ), wc_cart_totals_shipping_method_label_total( $method ) );


				//echo '<input type="hidden" name="shipping_method[%1$d]" data-index="%1$d" id="shipping_method_%1$d" value="%2$s" class="shipping_method" />';
				//echo wc_cart_totals_shipping_method_label_total( $method );
